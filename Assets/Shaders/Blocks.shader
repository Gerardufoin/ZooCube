...
////// Emissive:
                ...
                float4 _Face_var = tex2D(_Face,TRANSFORM_TEX(node_9861, _Face));
                float node_8436 = (1.0 - _Face_var.a);
                float node_3736 = 1.0;
                ...
                float3 emissive = ((((_Face_var.rgb*_Face_var.a*_Color.rgb)+(node_8436*_BackgroundColor.rgb))*(1.0 - node_2764.rgb).r)+(_BorderColor.rgb*node_2764.rgb));
                float3 finalColor = emissive;
                float4 node_8617 = tex2D(_ShapeMask,TRANSFORM_TEX(i.uv0, _ShapeMask));
                return fixed4(finalColor,saturate((((_Face_var.a*_Color.a)+(node_8436*_BackgroundColor.a))*(1.0 - node_8617.r)*_BorderColor.a)));
            }
            ENDCG
        }
        Pass {
