	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 ScaleRatio78 = appendResult17_g2;
				...
				float4 temp_output_6_0_g13 = appendResult77;
				float2 uv11_g13 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 ScaleRatio8_g13 = ScaleRatio78;
				float2 temp_output_10_0_g13 = ( _BorderWidth / ScaleRatio8_g13 );
				float2 appendResult17_g13 = (float2(( uv11_g13.x * ( temp_output_10_0_g13 + float2( 1,1 ) ).x ) , ( uv11_g13.y * ( temp_output_10_0_g13 + float2( 1,1 ) ).y )));
				float2 appendResult18_g13 = (float2(_BorderXOffset , _BorderYOffset));
				float4 tex2DNode24_g13 = tex2D( _ShapeMask, ( ( appendResult17_g13 - ( temp_output_10_0_g13 / float2( 2,2 ) ) ) + ( appendResult18_g13 / ScaleRatio8_g13 ) ) );
				float2 uv_ShapeMask = IN.texcoord.xy * _ShapeMask_ST.xy + _ShapeMask_ST.zw;
				float clampResult34_g13 = clamp( ( (temp_output_6_0_g13).a * ( 1.0 - tex2D( _ShapeMask, uv_ShapeMask ).r ) * _BorderColor.a ) , 0.0 , 1.0 );
				float4 appendResult38_g13 = (float4((( float4( ( (temp_output_6_0_g13).rgb * ( 1.0 - tex2DNode24_g13.r ) ) , 0.0 ) + ( _BorderColor * tex2DNode24_g13 ) )).rgb , clampResult34_g13));
				
				fixed4 c = appendResult38_g13;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=14201
-1760;143;1637;872;1842.519;257.2526;1.3;True;False
Node;AmplifyShaderEditor.FunctionNode;31;-740.7661,726.5918;Float;False;ScalingRatio;-1;;2;096dc3062cc962b49b5311cdb37df263;0;3;FLOAT2;0;FLOAT;27;FLOAT;28
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-2122.484,212.8895;Float;False;Property;_ImageYOffset;ImageYOffset;4;0;Create;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-2120.276,124.5792;Float;False;Property;_ImageXOffset;ImageXOffset;3;0;Create;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-1349.593,456.7012;Float;False;Property;_BackgroundColor;BackgroundColor;2;0;Create;0.6313726,0.4,0.2196079,1;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;77;-405.8012,299.591;Float;False;FLOAT4;4;0;FLOAT3;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;3;FLOAT;0.0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;88;-185.6634,383.2658;Float;False;AddBorder;0;;13;e22a0ad25ec970f4d94f3a43eb80ec65;2;6;COLOR;0,0,0,0;False;7;FLOAT2;1,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;5
...
ASEEND*/
//CHKSM=6683A952137FEC8F09971A22B427E99928348405