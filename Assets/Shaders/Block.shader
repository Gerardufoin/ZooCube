	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 temp_output_62_0 = ( ifLocalVar47_g140 / _FaceScale );
				...
				float4 temp_output_6_0_g149 = appendResult77;
				float2 uv11_g149 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult100_g149 = (float2(( _BordersWidth.x + _BordersWidth.z ) , ( _BordersWidth.y + _BordersWidth.w )));
				float2 appendResult109_g149 = (float2(ase_objectScale.x , ase_objectScale.y));
				float2 ScaleRatio8_g149 = appendResult109_g149;
				float2 break12_g149 = ( ( appendResult100_g149 / ScaleRatio8_g149 ) + 1.0 );
				float2 appendResult17_g149 = (float2(( uv11_g149.x * break12_g149.x ) , ( uv11_g149.y * break12_g149.y )));
				float2 appendResult101_g149 = (float2(_BordersWidth.x , _BordersWidth.y));
				float2 BorderCoordinates102_g149 = ( appendResult101_g149 / ScaleRatio8_g149 );
				float2 appendResult18_g149 = (float2(_BorderXOffset , _BorderYOffset));
				float2 temp_output_23_0_g149 = ( ( appendResult17_g149 - BorderCoordinates102_g149 ) + ( appendResult18_g149 / ScaleRatio8_g149 ) );
				float2 break60_g149 = step( float2( 0,0 ) , ( 1.0 - temp_output_23_0_g149 ) );
				float2 break61_g149 = step( float2( 0,0 ) , temp_output_23_0_g149 );
				float clampResult68_g149 = clamp( ( tex2D( _ShapeMask, temp_output_23_0_g149 ).r + ( 1.0 - ( break60_g149.x * break60_g149.y * break61_g149.x * break61_g149.y ) ) ) , 0.0 , 1.0 );
				float2 uv_ShapeMask = IN.texcoord.xy * _ShapeMask_ST.xy + _ShapeMask_ST.zw;
				float clampResult34_g149 = clamp( ( (temp_output_6_0_g149).a * ( 1.0 - tex2D( _ShapeMask, uv_ShapeMask ).r ) * _BorderColor.a ) , 0.0 , 1.0 );
				float4 appendResult38_g149 = (float4((( float4( ( (temp_output_6_0_g149).rgb * ( 1.0 - clampResult68_g149 ) ) , 0.0 ) + ( _BorderColor * clampResult68_g149 ) )).rgb , clampResult34_g149));
				
				fixed4 c = ( appendResult38_g149 + ( _ID * 0.0 ) );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=16100
-1709;79;1627;915;3762.706;472.7621;1;True;False
Node;AmplifyShaderEditor.FunctionNode;219;-2932.547,-151.6834;Float;False;ScalingRatio;-1;;140;096dc3062cc962b49b5311cdb37df263;0;0;3;FLOAT2;0;FLOAT;27;FLOAT;28
Node;AmplifyShaderEditor.RangedFloatNode;61;-3029.872,-25.54801;Float;False;Property;_FaceScale;FaceScale;9;0;Create;True;0;0;False;0;1;1;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;9;-1349.593,456.7012;Float;False;Property;_BackgroundColor;BackgroundColor;7;0;Create;True;0;0;False;0;0.6313726,0.4,0.2196079,1;0.6313726,0.4,0.2235294,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-344.8201,719.7365;Float;False;Property;_ID;ID;6;1;[PerRendererData];Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;228;-185.6634,383.2658;Float;False;AddBorder;0;;149;e22a0ad25ec970f4d94f3a43eb80ec65;0;1;6;COLOR;0,0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;5
