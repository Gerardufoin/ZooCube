	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 break12_g98 = ( temp_output_10_0_g98 + 1.0 );
				float2 appendResult17_g98 = (float2(( uv11_g98.x * break12_g98.x ) , ( uv11_g98.y * break12_g98.y )));
				...
				float2 break60_g98 = step( float2( 0,0 ) , ( 1.0 - temp_output_23_0_g98 ) );
				float2 break61_g98 = step( float2( 0,0 ) , temp_output_23_0_g98 );
				float clampResult68_g98 = clamp( ( tex2D( _ShapeMask, temp_output_23_0_g98 ).r + ( 1.0 - ( break60_g98.x * break60_g98.y * break61_g98.x * break61_g98.y ) ) ) , 0.0 , 1.0 );
				...
				fixed4 c = ( appendResult38_g98 + ( _ID * 0.0 ) );
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=15301
-1690;106;1627;892;1099.82;-34.73642;1;True;False
...
ASEEND*/
//CHKSM=0EB5418538AC2A653A39070263ECC3244B5D735F