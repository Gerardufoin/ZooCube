	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float clampResult49_g97 = clamp( ase_objectScale.x , 0.0 , 1.0 );
				float clampResult50_g97 = clamp( ase_objectScale.y , 0.0 , 1.0 );
				float2 appendResult57_g97 = (float2(( ase_objectScale.x / clampResult50_g97 ) , 1.0));
				float2 appendResult58_g97 = (float2(1.0 , ( ase_objectScale.y / clampResult49_g97 )));
				float2 ifLocalVar47_g97 = 0;
				if( clampResult49_g97 > clampResult50_g97 )
				ifLocalVar47_g97 = appendResult57_g97;
				else if( clampResult49_g97 == clampResult50_g97 )
				ifLocalVar47_g97 = (ase_objectScale).xy;
				else if( clampResult49_g97 < clampResult50_g97 )
				ifLocalVar47_g97 = appendResult58_g97;
				float2 ScaleRatio78 = ifLocalVar47_g97;
				...
				float4 temp_output_6_0_g98 = appendResult77;
				float2 uv11_g98 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 ScaleRatio8_g98 = ScaleRatio78;
				float2 temp_output_10_0_g98 = ( _BorderWidth / ScaleRatio8_g98 );
				float2 appendResult17_g98 = (float2(( uv11_g98.x * ( temp_output_10_0_g98 + 1.0 ).x ) , ( uv11_g98.y * ( temp_output_10_0_g98 + 1.0 ).y )));
				float2 appendResult18_g98 = (float2(_BorderXOffset , _BorderYOffset));
				float2 temp_output_23_0_g98 = ( ( appendResult17_g98 - ( temp_output_10_0_g98 / 2.0 ) ) + ( appendResult18_g98 / ScaleRatio8_g98 ) );
				float clampResult68_g98 = clamp( ( tex2D( _ShapeMask, temp_output_23_0_g98 ).r + ( 1.0 - ( step( float2( 0,0 ) , ( 1.0 - temp_output_23_0_g98 ) ).x * step( float2( 0,0 ) , ( 1.0 - temp_output_23_0_g98 ) ).y * step( float2( 0,0 ) , temp_output_23_0_g98 ).x * step( float2( 0,0 ) , temp_output_23_0_g98 ).y ) ) ) , 0.0 , 1.0 );
				float2 uv_ShapeMask = IN.texcoord.xy * _ShapeMask_ST.xy + _ShapeMask_ST.zw;
				float clampResult34_g98 = clamp( ( (temp_output_6_0_g98).a * ( 1.0 - tex2D( _ShapeMask, uv_ShapeMask ).r ) * _BorderColor.a ) , 0.0 , 1.0 );
				float4 appendResult38_g98 = (float4((( float4( ( (temp_output_6_0_g98).rgb * ( 1.0 - clampResult68_g98 ) ) , 0.0 ) + ( _BorderColor * clampResult68_g98 ) )).rgb , clampResult34_g98));
				
				fixed4 c = appendResult38_g98;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=14301
2097;77;1666;915;3609.933;788.5186;2.03485;True;True
Node;AmplifyShaderEditor.FunctionNode;170;-740.7661,726.5918;Float;False;ScalingRatio;-1;;97;096dc3062cc962b49b5311cdb37df263;0;0;3;FLOAT2;0;FLOAT;27;FLOAT;28
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-3029.872,-25.54801;Float;False;Property;_ImageScale;ImageScale;1;0;Create;True;1;0;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-2122.484,212.8895;Float;False;Property;_ImageYOffset;ImageYOffset;5;0;Create;True;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-2120.276,124.5792;Float;False;Property;_ImageXOffset;ImageXOffset;4;0;Create;True;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;-1394.203,-32.06759;Float;True;Property;_Face;Face;2;0;Create;True;2e5f3a3c9a063494b924449bc184dd90;2e5f3a3c9a063494b924449bc184dd90;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-1349.593,456.7012;Float;False;Property;_BackgroundColor;BackgroundColor;3;0;Create;True;0.6313726,0.4,0.2196079,1;0,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;171;-185.6634,383.2658;Float;False;AddBorder;0;;98;e22a0ad25ec970f4d94f3a43eb80ec65;0;2;6;COLOR;0,0,0,0;False;7;FLOAT2;1,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;5
Node;AmplifyShaderEditor.TemplateMasterNode;1;30.08085,387.2263;Float;False;True;2;Float;ASEMaterialInspector;0;4;ZooCube/Block;0f8ba0101102bb14ebf021ddadce9b49;Sprites Default;3;One;OneMinusSrcAlpha;0;One;Zero;Off;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
WireConnection;78;0;170;0
...
ASEEND*/
//CHKSM=93191A7166BE47BDAC6099AFC36792550556C8CD