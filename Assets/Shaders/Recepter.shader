...
////// Emissive:
                ...
                float4 node_2764 = tex2D(_MainTex,TRANSFORM_TEX(node_1117, _MainTex));
                float3 emissive = ((_BackgroundColor.rgb*(1.0 - node_2764.rgb).r)+(_BorderColor.rgb*node_2764.rgb));
                float3 finalColor = emissive;
                float4 node_8617 = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
